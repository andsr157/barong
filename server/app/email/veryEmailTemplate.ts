...
const verifyEmailTemplate = function (
                        ...
                        <tr>
                          <td class="sm-px-24"
                            style="--bg-opacity: 1; background-color: #ffffff;  border-radius: 4px; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; font-size: 14px; line-height: 24px; padding: 48px; text-align: left; --text-opacity: 1; color: #626262;"
                             align="left">
                            <p style="font-weight: 600; font-size: 18px; margin-bottom: 0;">Halo jagoan barong,</p>
  
                            <p style="margin: 0 0 24px;">
                              Permintaan untuk mengganti password
                              Gunakan link dibawah
                            </p>
  
                            <lable style="display: block; font-size: 24px; line-height: 100%; margin-bottom: 24px; --text-opacity: 1; color: #000000; text-decoration: none;"><a href="${otp}">Klik link ini</a></lable>
  ...
  const text = `
          Permintaan reset kata sandi, gunakan link yang diberikan untuk mereset kata sandi `
  return {
    html,
    text
  }
