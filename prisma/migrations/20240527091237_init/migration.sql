-- CreateEnum
CREATE TYPE "NotificationMode" AS ENUM ('PUSH', 'IN_APP');
...
-- CreateIndex
CREATE UNIQUE INDEX "PushSubscription_user_id_key" ON "PushSubscription"("user_id");
...
-- AddForeignKey
ALTER TABLE "PushSubscription" ADD CONSTRAINT "PushSubscription_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "user_notification" ADD CONSTRAINT "user_notification_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
